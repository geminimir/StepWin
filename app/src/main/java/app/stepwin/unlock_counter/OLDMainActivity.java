...
public class OLDMainActivity extends Activity implements AdapterView.OnItemSelectedListener {
 ...
 */   }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.d(LOG_TAG, "OLDMainActivity created");
        startService(new Intent(OLDMainActivity.this, LockerService.class));
...
/*
  ...
  */  }
    ...
    protected void onResume() {
        Log.d(LOG_TAG, "OLDMainActivity resume");
        super.onResume();
        bu.dataChanged();
        refresh_all();
    }
